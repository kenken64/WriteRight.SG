...
Provide the rewrite in JSON format. Include detailed bandJustification with specific before/after examples explaining how each key change pushes the score from Band {{currentBand}} to Band {{targetBand}}.`,
};
